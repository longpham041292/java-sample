...
public class CreditBookingAPI {
	...
	@RequiredAdminRole
	public ResponseEntity<Object> eticketBooking(
		...
		try {
			...
			List<BookingServiceDTO> result = creditBookingService.eticketBookingService(keyword ,start ,end , status, type ,pageable);
	...
	@RequiredAdminRole
	public ResponseEntity<Object> classBooking(
						@RequestParam(name = "from") Long startTime,
						@RequestParam(name = "to") Long endTime,
						@RequestParam(name = "keyword", required = false, defaultValue = "") String keyword, 
						@RequestParam(name = "status") List<Integer> status,
	...
	@RequiredAdminRole
	public StreamingResponseBody exportEticketBooking(
						@RequestParam(name = "from") Long startTime,
						@RequestParam(name = "to") Long endTime,
						@RequestParam(name = "keyword", required = false, defaultValue = "") String keyword,
						@RequestParam(name = "status") List<Integer> status,
	...
	@RequiredAdminRole
	public StreamingResponseBody exportClassBooking(
						@RequestParam(name = "from") Long startTime,
						@RequestParam(name = "to") Long endTime,
						@RequestParam(name = "keyword", required = false, defaultValue = "") String keyword,
						@RequestParam(name = "status") List<Integer> status,
