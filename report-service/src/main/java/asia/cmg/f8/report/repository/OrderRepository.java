...
import asia.cmg.f8.report.entity.database.OrderSubscriptionEntryEntity;
...
public interface OrderRepository extends JpaRepository<OrderEntity, Long> {
	...
	final String GET_TOP_UP_REPORT_ALL_USER_QUERY
		= " SELECT "
		+ " NEW asia.cmg.f8.report.dto.TopUpReportDto("
		+ " orderEntity,"
		+ " userEntity, "
		+ " unitCreditPackage "
		+ ")"		
		...
		+ " JOIN CreditPackageEntity unitCreditPackage ON unitCreditPackage.creditType = :packageType "
	...
	Page<TopUpReportDto> getTopUpReport( @Param("start")  LocalDateTime start, 
										  ...
										  @Param("packageType") CreditPackageType packageType,
										Pageable pageable);
