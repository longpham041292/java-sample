 ...
 * Created on 2/16/17.
 */
@Service(DefaultSessionBookingService.SERVICE_ID)
public class DefaultSessionBookingService extends AbstractSessionBookingService {

	public static final String SERVICE_ID = "defaultSessionBookingService";

	public DefaultSessionBookingService(final SessionManagementService sessionManagementService,
