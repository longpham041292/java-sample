...
public class BookingManagementDTO {
	...
	public BookingManagementDTO() {
		super();
	}
	
	public BookingManagementDTO(CreditSessionBookingEntity entity, BasicUserEntity pt, BasicUserEntity eu) {
	...
	public BookingManagementDTO(CreditBookingEntity entity, BasicUserEntity eu) {
		final String DATE_PATTERN = "dd/MM/yyyy hh:mm:ss a";
		if(entity != null) {
