...
public class UserProfileResponse_V2 {
	...
	private UserPTiMatchDTO_V2 userPTiMatch;
	...
	public static class Builder {
		...
		public UserProfileResponse_V2 build() {
			UserProfileResponse_V2 userProfile = new UserProfileResponse_V2();
			...
			userProfile.setPtBookingCredit(ptBookingCredit);

			return userProfile;
		}
		
		public Builder setUserPTiMatch(UserPTiMatchDTO_V2 userPTiMatch) {
			this.userPTiMatch = userPTiMatch;
			return this;
		}
		
		public Builder setPtBookingCredit(Integer ptBookingCredit) {
	...
	public UserPTiMatchDTO_V2 getUserPTiMatch() {
		return userPTiMatch;
	}

	public void setUserPTiMatch(UserPTiMatchDTO_V2 userPTiMatch) {
		this.userPTiMatch = userPTiMatch;
	}
