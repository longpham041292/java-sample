...
public final class OneSignal {
	...
	private OneSignalComms oneSignalComm = null;
	private static OneSignal instance = new OneSignal();

    private OneSignal() {
    	if(oneSignalComm == null) {
    		oneSignalComm = oneSignal();
    	}
    }
    
    public static OneSignal getInstance() {
    	return instance;
    }
     ...
     * @return the response
     */
    public CreateNotificationResponse createNotification(String appAuthKey, NotificationRequest notificationRequest) {
        return oneSignalComm.createNotification(appAuthKey, notificationRequest);
    }
     ...
     */
    public void cancelNotification(String appAuthKey, String appId, String notificationId) {
        oneSignalComm.cancelNotification(appAuthKey, appId, notificationId);
    }
     ...
     */
    public ViewNotificationResponse viewNotification(String appAuthKey, String appId, String notificationId) {
        return oneSignalComm.viewNotification(appAuthKey, appId, notificationId);
    }
     ...
     */
    public ViewNotificationsResponse viewNotifications(String appAuthKey, String appId, Number limit, Number offset) {
        return oneSignalComm.viewNotifications(appAuthKey, appId, limit, offset);
    }
     ...
     */
    public void trackOpen(String appId, String notificationId) {
    	oneSignalComm.trackOpen(appId, notificationId);
    }
     ...
     */
    public List<AppResponse> viewApps(String userAuthKey) {
        return oneSignalComm.viewApps(userAuthKey);
    }
     ...
     */
    public AppResponse viewApp(String userAuthKey, String appId) {
        return oneSignalComm.viewApp(userAuthKey, appId);
    }
     ...
     */
    public AppResponse createApp(String userAuthKey, App app) {
        return oneSignalComm.createApp(userAuthKey, app);
    }
     ...
     */
    public AppResponse updateApp(String userAuthKey, App app) {
        return oneSignalComm.updateApp(userAuthKey, app.getId(), app);
    }
     ...
     */
    public ViewDevicesResponse viewDevices(String appAuthKey, String appId, Number limit, Number offset) {
        return oneSignalComm.viewDevices(appAuthKey, appId, limit, offset);
    }
     ...
     */
    public ViewDeviceResponse viewDevice(String appAuthKey, String appId, String deviceId) {
        return oneSignalComm.viewDevice(appAuthKey, appId, deviceId);
    }
     ...
     */
    public AddDeviceResponse addDevice(AddEditDeviceRequest device) {
        return oneSignalComm.addDevice(device);
    }
     ...
     */
    public SuccessResponse editDevice(String deviceId, AddEditDeviceRequest device) {
        return oneSignalComm.editDevice(deviceId, device);
    }
     ...
     */
    public SuccessResponse newSession(String deviceId, Session session) {
        return oneSignalComm.newSession(deviceId, session);
    }
     ...
     * @return response with status
     */
    public SuccessResponse newPurchase(String deviceId, Purchases purchases) {
        return oneSignalComm.newPurchase(deviceId, purchases);
    }
     ...
     * @return response with status
     */
    public SuccessResponse incrementSessionLength(String deviceId, Long activeTime) {
        return oneSignalComm.incrementSessionLength(deviceId, activeTime);
    }
     ...
     */
    public CsvExportFileLocationResponse csvExportFileLocation(String appAuthKey, String appId,
            CsvExportFileLocationRequest csvExportFileLocationRequest) {
        return oneSignalComm.csvExportLocation(
                appAuthKey,
                appId,
