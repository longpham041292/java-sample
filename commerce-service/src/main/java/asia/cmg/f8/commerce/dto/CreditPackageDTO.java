...
public class CreditPackageDTO {
	...
	public CreditPackageDTO(CreditPackageEntity c) {
		this.title = c.getTitle();
		this.price = c.getPrice();
		this.totalPrice = c.getTotalPrice();
		this.credit = c.getCredit();
		this.bonusCredit = c.getBonusCredit();
		this.totalCredit = c.getTotalCredit();
		this.country = c.getCountry();
		this.currency = c.getCurrency();
		this.type = c.getCreditType();
		this.numberOfExpiredDay = c.getNumberOfExpiredDay();
